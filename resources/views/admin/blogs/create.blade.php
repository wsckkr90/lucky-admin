                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                HTML content can be stored here if your frontend renderer supports it.
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            @foreach($authors as $author)
                                ...
                                <option
                                    value="{{ $author->id }}"
                                    @selected((string) old('author_id') === (string) $author->id)
                                >
                                    {{ $author->name }}
                                </option>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="form-text">
                                Image upload can be added later without changing the database structure.
                            </div>
